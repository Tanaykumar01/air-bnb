...
PhotoUploaders.propTypes = {
    addedPhotos: PropTypes.arrayOf(PropTypes.string).isRequired,
    onChange: PropTypes.func.isRequired,
};
export default function PhotoUploaders({addedPhotos, onChange}) {
    ...
    return (
        <>
            <div className="flex gap-2">
                ...
                <button onClick={addPhotoByLink} className="bg-grey-200 px-4 rounded-2xl ">Add&nbsp;Photos</button>
            </div>
